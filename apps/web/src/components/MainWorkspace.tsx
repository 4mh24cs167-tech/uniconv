...
export function MainWorkspace({ initialSlug }: { initialSlug?: string }) {
  ...
  useEffect(() => {
    ...
    const toolMappings: Record<string, { view: ViewState, title: string, targetFormat?: string }> = {
      "audio-converter": { view: "AUDIO_CONVERTER", title: "Audio Conversions" },
      "secure-pdf": { view: "SECURE_PDF", title: "Secure PDF" },
      "merge-pdf": { view: "UNIVERSAL_CONVERTER", title: "Merge PDF", targetFormat: "pdf" },
      "split-pdf": { view: "UNIVERSAL_CONVERTER", title: "Split PDF", targetFormat: "pdf" },
      "compress-pdf": { view: "UNIVERSAL_CONVERTER", title: "Compress PDF", targetFormat: "pdf" },
      "pdf-to-word": { view: "UNIVERSAL_CONVERTER", title: "PDF to Word", targetFormat: "docx" },
      "pdf-to-powerpoint": { view: "UNIVERSAL_CONVERTER", title: "PDF to PowerPoint", targetFormat: "pptx" },
      "pdf-to-excel": { view: "PDF_TO_EXCEL", title: "PDF to Excel", targetFormat: "xlsx" },
      "word-to-pdf": { view: "UNIVERSAL_CONVERTER", title: "Word to PDF", targetFormat: "pdf" },
      "powerpoint-to-pdf": { view: "UNIVERSAL_CONVERTER", title: "PowerPoint to PDF", targetFormat: "pdf" },
